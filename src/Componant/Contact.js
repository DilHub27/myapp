    ...
    <div
      ...
      <div className="max-w-2xl  mt-14  ml-[20px]">
        ...
        <p
          ...
          Whether you have a project  relevant  idea, a question,<br/>  I'm here to help.Let's connect and build something great together.
        </p>
        ...
        <input
          ...
          className="rounded-lg border text-zinc-50 border-amber-200  focus:ring-2 focus:ring-teal-500 max-w-sm w-full relative z-10 mt-4  bg-neutral-950 placeholder:text-neutral-700" />
      
       <p className="text-gray-50 ">Last Name</p>
       <input
          type="text"
          placeholder="Ex.Ranathunga"
          className="rounded-lg  border text-zinc-50 border-amber-200 focus:ring-2 focus:ring-teal-500  max-w-sm w-full relative z-10 mt-2  bg-neutral-950 placeholder:text-neutral-700" />
