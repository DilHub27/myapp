...
export const MacbookScroll = ({
  ...
  return (
    <div
      ...
      {/* Base area */}
      <div
        className="relative -z-10 h-[28rem] w-[32rem] overflow-hidden rounded-2xl bg-gray-200 dark:bg-[#272729]">
        {/* above keyboard bar */}
        ...
        {showGradient && (
          <div
            className="absolute inset-x-0 bottom-0 z-50 h-[100px] w-full bg-gradient-to-t from-white via-white to-transparent dark:from-black dark:via-black"></div>
        )}
  ...
  return (
    <div className="relative [perspective:800px]">
      ...
      <section>
        ...
        <div className="w-[50%] h-full float-left bg-orange-200 w-sm-[400px]"  >
              {/* Soft Skills */}
      <section>
        <h2 className="text-sm font-bold mb-6 border-b-2 border-gray-300 inline-block p-">
